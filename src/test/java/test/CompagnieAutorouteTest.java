...
import umlProjet.CompagnieAutoroute;
import umlProjet.Porte;
import umlProjet.PorteEntree;
import umlProjet.PorteSortie;
import umlProjet.Route;
import umlProjet.Tarif;
...
public class CompagnieAutorouteTest {
    ...
    void testObtenirTarifExacte() {
        ...
        Route r2 = new Route();
        Porte pA = new PorteEntree(10);
        Porte pB = new PorteSortie(20);
        Porte pC = new PorteSortie(30);
        Porte pD = new PorteSortie(40);
